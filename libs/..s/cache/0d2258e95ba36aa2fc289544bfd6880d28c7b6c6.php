...
<div class="container">
    <form action="<?php echo e(URL.'marca/save'); ?>" method="POST" id="myForm">
        <div class="form-group">
            <input type="hidden" name="IdMarca" value="<?php echo e($data->IdMarca); ?>">
        </div>
        <div class="row">
            <div class="col">
                <div class="form-group">
...
<script src="<?php echo e(URL); ?>js/mis_scripts/marca.js"></script>
<?php /**PATH C:\xampp\htdocs\MiBodega\app\views/marca/detail.blade.php ENDPATH**/ ?>